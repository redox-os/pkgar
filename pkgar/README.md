...
- bit 0-7, enumeration from 0-255 represent the data and entry struct version:
  - `0`: initial version
  - others: reserved
- bit 8-15, enumeration from 0-255 represent the binary achitecture it contains:
